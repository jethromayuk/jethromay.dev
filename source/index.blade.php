...
@section('body')
    <article class="mx-auto" itemscope="itemscope" itemtype="http://schema.org/Article">
        <section class="bg-madison min-h-screen grid grid-rows-2 lg:grid-cols-2 lg:grid-rows-none" itemprop="articleSection">
