    ...
    <section class="bg-madison flex sm:h-full pb-12 sm:px-6 lg:py-32" style="min-height: calc(100vh - 124px)">
        <div class="flex flex-col-reverse mx-auto max-w-7xl sm:px-6 lg:px-0 lg:flex-row lg:flex-grow lg:justify-between">
            <div class="flex-1 px-6 lg:pl-0 lg:pr-6">
                ...
                <p class="font-medium text-white text-lg my-4 md:text-xl">I'm a Web Developer at <a href="https://www.minttwist.com/" target="_blank" rel="noopener noreferrer" class="font-semibold text-niagara underline hover:text-niagara-light">Minttwist</a>, where I primarily work with Laravel and WordPress building bespoke systems and websites.</p>
