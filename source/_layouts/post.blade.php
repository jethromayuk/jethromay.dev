...
@section('body')
    <article class="py-24 max-w-4xl mx-auto w-full">
        ...
        <footer class="mt-6">
            <a class="text-lg underline text-green-500" href="http://twitter.com/share?text=2020%20In%20Review via @jethromayuk&amp;url=https%3a%2f%2fjethromay.com%2fposts%2f2020-in-review%2f" onclick="window.open(this.href,'twitter-share','width=550,height=235');return false;">
                Share on Twitter
            </a>
        </footer>
    </article>
